...
# T-0001-10 is a submission-process ticket, not a code ticket. Every AC
...
pytestmark = pytest.mark.skip(reason="T-0001-10: manual submission checklist, not automatable")
