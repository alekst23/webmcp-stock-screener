# T-0002-5: Structurally enforce failure logging instead of relying on convention
...
Epic review of EPIC-0002 found that AC3 ("failed actions appear in the log with a
