...
|---|--------|-------|------------|--------|
| 1 | T-0002-1 | Unify action recording | — | Done |
| 2 | T-0002-2 | Persist the action log | T-0002-1 | Done |
| 3 | T-0002-3 | Timeline UI + remove raw state dump | T-0002-1 | Done |
| 4 | T-0002-4 | Validate persisted activity log shape on load | — | Open |
| 5 | T-0002-5 | Structurally enforce failure logging instead of relying on convention | — | Open |
...
- **Wave 1**: T-0002-1 — no dependencies
- **Wave 2** (parallel): T-0002-2, T-0002-3 — both depend on T-0002-1's shared recording entry point and `actor` field
