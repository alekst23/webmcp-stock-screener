...
|---|--------|-------|------------|--------|
| 1 | T-0003-1 | Panel-scoped histogram action | — | Done |
| 2 | T-0003-2 | Individual panel close | — | Done |
| 3 | T-0003-3 | Add removePanel persistence round-trip test | — | Open |
| 4 | T-0003-4 | Panel action polish — a11y, stuck-panel close, focus-state sync | — | Open |

## Dependency Graph

```
T-0003-1 (independent)
T-0003-2 (independent)
```

## Wave Plan

- **Wave 1** (parallel): T-0003-1, T-0003-2 — independent actions, both
...
- Reordering, resizing, or any chart interactivity beyond existing
  selection/zoom.
- The activity log redesign (tracked separately in #2 / EPIC-0002).
