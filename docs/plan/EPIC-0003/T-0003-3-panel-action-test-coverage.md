# T-0003-3: Add removePanel persistence round-trip test
...
Epic review of EPIC-0003 found `store.test.ts`'s `'individual panel removal'`
tests (T-0003-2) cover removal semantics but, unlike the file's own
