...
Deliberately throwaway proof-of-concept, superseded by T-0001-5. A minimal
FastAPI endpoint (`GET /api/spike/ping`) reads a couple of rows directly
from T-0001-1's mock Parquet panel and returns them — no read abstraction
here; a proper panel-reading contract belongs to T-0001-3. On the
...
that doesn't exist until T-0001-3/4 exist) is registered whose `execute()`
...
That was corrected during implementation: deploying to Render is T-0001-8's
...
[`T-0001-2-live-verification-runbook.md`](T-0001-2-live-verification-runbook.md).
