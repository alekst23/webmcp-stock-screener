...
against the mock dataset (T-0001-1), including correct handling of
...
5. Search results are verified correct against the mock dataset's
   deliberately known pattern instances (T-0001-1) — no false positives or
...
is a pandas/numpy adapter over the mock panel from T-0001-1 — `rolling`,
...
Measuring outcomes or splitting result sets (T-0001-4).
