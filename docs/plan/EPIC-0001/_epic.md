...
|---|--------|-------|------------|--------|
| 1 | T-0001-1 | Mock data layer | — | Done |
| 2 | T-0001-2 | Platform spike | T-0001-1 | Blocked — awaiting live human verification |
| 3 | T-0001-3 | Query engine core | T-0001-1 | Done |
| 4 | T-0001-4 | Query engine stats | T-0001-3 | Done |
| 5 | T-0001-5 | WebMCP integration | T-0001-2, T-0001-4 | Done |
| 6 | T-0001-6 | Frontend shell | — | Done |
| 7 | T-0001-7 | Frontend visualization | T-0001-6, T-0001-5 | Done |
| 8 | T-0001-8 | Deploy & ops (mock) | T-0001-4 | Blocked — awaiting live deployment |
| 9 | T-0001-9 | Real data pipeline (paid, deferred) | T-0001-1, T-0001-8 | Open |
| 10 | T-0001-10 | Submission package | T-0001-9 | Open |
...
T-0001-1 ──┬──> T-0001-2 ──┐
           │               ├──> T-0001-5 ──┬──> T-0001-7 ──┐
           └──> T-0001-3 ──> T-0001-4 ──┬───┘               │
                                        └──> T-0001-8 ───────┼──> T-0001-9 ──> T-0001-10
T-0001-6 ───────────────────────────────────────────────────┘
```

## Wave Plan

- **Wave 1** (parallel): T-0001-1, T-0001-6 — no dependencies
- **Wave 2** (parallel): T-0001-2, T-0001-3 — depend on Wave 1's mock data
- **Wave 3**: T-0001-4 — depends on Wave 2's engine core
- **Wave 4** (parallel): T-0001-5, T-0001-8 — depend on Wave 2/3
- **Wave 5** (parallel): T-0001-7, T-0001-9 — depend on Wave 4
- **Wave 6**: T-0001-10 — depends on Wave 5's real data
