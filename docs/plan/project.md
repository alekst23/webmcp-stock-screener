...
| EPIC-1009: Screener core | epic | **9/10 tickets done, paused on account session limit** (reset 2:20pm ET, 2026-09-02) | `epic/EPIC-1009-screener-core` | **Landed:** T-1009-1 through T-1009-9, including T-1009-9 (`run_screener` with pinned run store — the `run_id` contract EPIC-1010 needs). **Remaining:** T-1009-10 (wire screener tools) only. Not yet re-verified with `npm test`/`typecheck` on this branch since the last commit — do that before resuming T-1009-10. |
...
| EPIC-1012: Similarity search | epic | **1/8 tickets done, paused on account session limit** (reset 2:20pm ET, 2026-09-02) | `epic/EPIC-1012-similarity-search` | **Landed:** T-1012-1 (similarity feature and scoring contract). **Remaining:** T-1012-2 through T-1012-8. Consumes EPIC-1011's captured-setup contract at `src/lib/workbench/chart/domain/capturedSetup.ts`. |
