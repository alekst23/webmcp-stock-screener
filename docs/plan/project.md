...
1. **EPIC-0020 merged** — MVP's core deliverable (live screener demo wiring)
   ...
   a real `ScreenerMarketData` adapter (so `run_screener` stops refusing
