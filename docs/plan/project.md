...
| EPIC-1012: Similarity search | epic | **implementation in flight** (2026-09-02, `/at-project-go` background agent) | `epic/EPIC-1012-similarity-search` (created from `main` by the agent) | 8 tickets, all Open at launch. 3 tools. Consumes EPIC-1011's captured-setup contract at `src/lib/workbench/chart/domain/capturedSetup.ts` (`CapturedChartSetup`, `readCapturedSetup`, `readCapturedSetups`). |
