...
|---|--------|-------|------------|--------|
| 1 | T-0005-1 | Snapshot persistence layer | — | Done |
| 2 | T-0005-2 | Snapshot picker UI | T-0005-1 | Done |
| 3 | T-0005-3 | Handle localStorage write failures and reserved-name collisions | — | Open |
| 4 | T-0005-4 | Add SnapshotPicker test coverage and fix remount-fragile baseline | — | Open |
| 5 | T-0005-5 | Minor cleanup — dedupe empty-workspace literal, shared test fake, unused export | — | Open |
...
- **Wave 1**: T-0005-1 — no dependencies
- **Wave 2**: T-0005-2 — depends on T-0005-1's save/load/delete/list functions
...
7. The action/activity log (EPIC-0002) is not part of a snapshot's
   contents.
8. Resolves #5.
