...
const DESCRIPTION =
	...
	'a new set of typed conditions (give at most one of the two; omit both to only rename). Only a ' +
	'draft can be edited, and editing always keeps it a draft -- this tool cannot arm anything. ' +
	'Returns the mutation envelope with the edited alert; the undo_token restores the prior draft.';
